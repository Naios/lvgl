...
static void set_px_true_color_alpha(lv_disp_drv_t * disp_drv, uint8_t * buf, const lv_area_t * disp_area, lv_coord_t x,
                                    lv_coord_t y,
                                    lv_color_t color, lv_opa_t opa);

static void set_px_cb_alpha1(lv_disp_drv_t * disp_drv, uint8_t * buf, const lv_area_t * disp_area, lv_coord_t x, lv_coord_t y,
                             lv_color_t color, lv_opa_t opa);

static void set_px_cb_alpha2(lv_disp_drv_t * disp_drv, uint8_t * buf, const lv_area_t * disp_area, lv_coord_t x, lv_coord_t y,
                             lv_color_t color, lv_opa_t opa);

static void set_px_cb_alpha4(lv_disp_drv_t * disp_drv, uint8_t * buf, const lv_area_t * disp_area, lv_coord_t x, lv_coord_t y,
                             lv_color_t color, lv_opa_t opa);


static void set_px_cb_alpha8(lv_disp_drv_t * disp_drv, uint8_t * buf, const lv_area_t * disp_area, lv_coord_t x, lv_coord_t y,
                             lv_color_t color, lv_opa_t opa);
                             ...
                             lv_color_t color, lv_opa_t opa)
{
    ...
    lv_img_dsc_t d;
    d.data = buf;
    d.header.w = lv_area_get_width(disp_area);
